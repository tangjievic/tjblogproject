...
import SendCode from '../../pc/subassembly/sendcode/sendcode';
...
class UserLogin extends Component {
        ...
        return (
            <div className="mb-user_login">
                ...
                <div className="login_input">
                    <Row>
                        <Col span={24} className="input_form">
                            ...
                            <div ref={(ref)=>{(this as any).input_2 = ref}} className="form_box2">
                                ...
                                >
                                    ...
                                    <Form.Item {...tailLayout}>
                                        <Row>
                                            <Col span={12}>
                                                <Button type="link" onClick={()=>this.changeFlag(1)} style={{width:'95%'}}>
                                                    返回登录
                                                </Button>
                                            </Col>
                                        </Row>
    ...
    onFinish(values:any){
        ...
        userLogin(values).then((res:any)=>{
            ...
            setTimeout(()=>{
                (this as any).props.history.replace('/home');
            },500)
        })
    }
