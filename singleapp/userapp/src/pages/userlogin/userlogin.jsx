...
class UserLogin extends Component {
                ...
                <div className="login_input">
                    <Row>
                        ...
                        <Col span={14} className="input_form">
                            ...
                            <div ref={(ref)=>{this.input_2 = ref}} className="form_box2">
                            ...
                            <div ref={(ref)=>{this.input_3 = ref}} className="form_box2">
    ...
    changeFlag(type){
        let dom_1 = this[`input_${type}`]
        let dom_2 = this[`input_${this.state.type}`]
