...
var Icon = function() {
  ...
  return {
    info:function(width:any,height:any){
    ...
    warning:function(width:any,height:any){
    ...
    success:function(width:any,height:any){
    ...
    error:function(width:any,height:any){
...
var Button = function(color1:any,color2:any,text:any,type:any){
  var clickStatus = 0;
...
var TGTool = function() {
  ...
  return {
    ...
    confirm:function(title:any,text:any,callback1:any,callback2:any){
      //透明遮罩层
      var mask:any = document.createElement("div");
      ...
      var confirmDiv:any = document.createElement("div");
      //颜色
      ...
      var heightNum:any = confirmDiv.style.height.replace("px","");
